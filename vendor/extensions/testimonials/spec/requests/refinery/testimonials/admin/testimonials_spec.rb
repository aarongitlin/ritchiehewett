      ...
      describe "testimonials" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:testimonial, :title => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:testimonial, :title => "A title") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:testimonial, :title => "UniqueTitleOne") }
